...
for n, g in N10000g:
    ax1.scatter(g['size'], g['time'])

ax0.legend(loc='upper left', frameon = False,title="GC interval\n(generations)",fontsize='x-small')
for ax in [ax0,ax1]:
