...
the tools are currently available bundled with the Python package \msprime{},
but will soon be separately available as a package named \tskit{}, 
which will include a Python API and an embeddable C library.
