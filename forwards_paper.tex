...
and the tables must be sorted.
Algorithm~\algref{W} avoided both of these details since $t$ denotes
``time until the end of the simulation'',
and nonoverlapping generations ensure that the tables will be already sorted.
Finally, since $\tsimplify{P', \Nt, \Et}$ results in the $N$ individuals in $P'$
