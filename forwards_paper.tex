...
\algstep{W7.}{Record edges}{Set $E \leftarrow E \cup \left\{ (0, x, P_a, n), (x,
		L, P_b, n) \right\}$.
}
...
At any point in Algorithm~\algref{W}, genealogical history is recorded
...
Fortunately, \msprime{}'s API includes tools to rectify this by first sorting (using \texttt{sort\_tables})
