...
\begin{align*}
    \text{flags,} \qquad \text{population,} \qquad \text{time} \\ 
\end{align*}
...
\begin{align*}
    \text{left,} \qquad \text{right,} \qquad \text{parent,} \qquad \text{children}
\end{align*}
...
\begin{align*}
    \text{position,} \qquad \text{ancestral state}
\end{align*}
...
\begin{align*}
    \text{site,} \qquad \text{node,} \qquad \text{derived state}
\end{align*}
