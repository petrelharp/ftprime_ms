...
taking input parameters for population size $N$ and scaled recombination $\rho$.
As described in 'Simulation benchmarks', we set scaled mutation $\theta=\rho$,
...
We coupled \simupop{} to \msprime{} using a Python class \texttt{RecombCollector} 1)
...
\tedgetable{} upon which simplification is performed every 1000 years (using
...
After mating: nothing happens 999/1000 years, every 1000 years the tables are
simplifed.
