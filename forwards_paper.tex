...
and so adding them after simplification results in only around $\mu 4 N \log(2N)$ mutations,
...
combined with the $O(N \log N)$ storage for edges and nodes of a tree sequence above,
