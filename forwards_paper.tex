...
Our method uses more RAM (up to 2 orders of magnitude more) than simple forward simulations (see~\ref{ss:memuse_nosel}),
...
Set $\Nt \leftarrow \mbox{\texttt{NodeTable}}()$, $\mathcal{E}
