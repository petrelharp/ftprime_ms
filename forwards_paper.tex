...
\begin{itemize}
    ...
    \item the genetic segments each individual inherits from its parents in the Edge Table, and
...
% Finally, the first step in simplification is to \emph{sort} the tables
% according to several criteria, for algorithmic efficiency,
